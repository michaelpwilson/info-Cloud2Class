            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="list-inline">
                        <li><a href="http://www.brightprocess.com/">Our Homepage</a>
                        </li>
                        <li class="footer-menu-divider">&sdot;</li>
                        <li><a href="http://www.brightprocess.com/about-us/">About Bright Process Ltd</a>
                        </li>
                        <li class="footer-menu-divider">&sdot;</li>
                        <li><a href="http://www.brightprocess.com/contact-us/">Contact Us</a>
                        </li>
                        <li class="footer-menu-divider">&sdot;</li>
